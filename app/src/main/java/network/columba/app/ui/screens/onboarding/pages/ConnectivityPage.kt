...
fun ConnectivityPage(
    ...
    Column(
        ...
        InterfaceCard(
            ...
            statusText =
                when {
                    blePermissionsDenied -> stringResource(R.string.onboarding_connectivity_permissions_denied)
                    blePermissionsGranted -> stringResource(R.string.onboarding_connectivity_permissions_granted)
                    else -> null
                },
    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = stringResource(interfaceType.displayNameRes),
                ...
                Text(
                    text = stringResource(interfaceType.descriptionRes),
                    style = MaterialTheme.typography.bodyMedium,
                    color =
                        if (enabled) {
                ...
                interfaceType.secondaryDescriptionRes?.let { secondary ->
                    Text(
