...
fun IdentityCard(
    ...
    CollapsibleSettingsCard(
        ...
        Text(
            text = stringResource(R.string.identity_view_description),
        ...
        Text(
            text = stringResource(R.string.identity_manage_description),
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        ...
        Button(
            ...
            Text(stringResource(R.string.identity_view_my_identity))
        }
        ...
        OutlinedButton(
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text(stringResource(R.string.identity_manage_identities))
        }
    }
}
